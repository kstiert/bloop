...
namespace Bloop.Plugin.WebSearch
{
    public partial class WebSearchSetting : Window
    {
        ...
        private void btnAdd_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            {
                string warning = context.API.GetTranslation("Bloop_plugin_websearch_input_title");
                MessageBox.Show(warning);
                return;
            }
            ...
            {
                string warning = context.API.GetTranslation("Bloop_plugin_websearch_input_url");
                MessageBox.Show(warning);
                return;
            }
            ...
            {
                string warning = context.API.GetTranslation("Bloop_plugin_websearch_input_action_keyword");
                MessageBox.Show(warning);
                return;
            }
            ...
            if (!update)
            {
                ...
                {
                    string warning = context.API.GetTranslation("Bloop_plugin_websearch_action_keyword_exist");
                    MessageBox.Show(warning);
                    return;
                }
                ...
                string msg = context.API.GetTranslation("Bloop_plugin_websearch_succeed");
                MessageBox.Show(msg);
            }
            else
            {
