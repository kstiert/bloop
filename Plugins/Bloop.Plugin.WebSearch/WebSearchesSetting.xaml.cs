...
namespace Bloop.Plugin.WebSearch
{
    ...
    public partial class WebSearchesSetting : UserControl
    {
        ...
        private void btnDeleteWebSearch_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            {
                string msg = string.Format(context.API.GetTranslation("Bloop_plugin_websearch_delete_warning"),selectedWebSearch.Title);
            ...
            {
                string warning =context.API.GetTranslation("Bloop_plugin_websearch_pls_select_web_search");
