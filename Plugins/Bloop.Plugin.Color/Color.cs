...
namespace Bloop.Plugin.Color
{
    public sealed class ColorsPlugin : IPlugin, IPluginI18n
    {
        ...
        {
            return context.API.GetTranslation("Bloop_plugin_color_plugin_name");
        }

        public string GetTranslatedPluginDescription()
        {
            return context.API.GetTranslation("Bloop_plugin_color_plugin_description");
        }
    }
}