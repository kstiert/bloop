...
namespace Bloop.Plugin.ControlPanel
{
    public class ControlPanel : IPlugin,IPluginI18n
    {
        ...
        {
            return context.API.GetTranslation("Bloop_plugin_controlpanel_plugin_name");
        }

        public string GetTranslatedPluginDescription()
        {
            return context.API.GetTranslation("Bloop_plugin_controlpanel_plugin_description");
        }
    }
}
