    ...
    public class Sys : IPlugin, ISettingProvider, IPluginI18n
    {
        ...
        private void LoadCommands()
        {
            availableResults.AddRange(new Result[] { 
				...
				{
					Title = "Shutdown",
					SubTitle = context.API.GetTranslation("Bloop_plugin_sys_shutdown_computer"),
					Score = 100,
				...
				{
				    Title = "Log off",
                    SubTitle = context.API.GetTranslation("Bloop_plugin_sys_log_off"),
				    Score = 100,
				...
				{
				    Title = "Lock",
                    SubTitle = context.API.GetTranslation("Bloop_plugin_sys_lock"),
				    Score = 100,
				...
				{
				    Title = "Exit",
                    SubTitle = context.API.GetTranslation("Bloop_plugin_sys_exit"),
				    Score = 110,
				...
				{
				    Title = "Restart Bloop",
                    SubTitle = context.API.GetTranslation("Bloop_plugin_sys_restart"),
				    Score = 110,
        ...
        {
            return context.API.GetTranslation("Bloop_plugin_sys_plugin_name");
        }

        public string GetTranslatedPluginDescription()
        {
            return context.API.GetTranslation("Bloop_plugin_sys_plugin_description");
        }
    }
}
