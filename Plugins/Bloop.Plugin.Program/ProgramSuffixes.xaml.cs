...
namespace Bloop.Plugin.Program
{
    ...
    public partial class ProgramSuffixes
    {
        ...
        private void ButtonBase_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            {
                string warning = context.API.GetTranslation("Bloop_plugin_program_suffixes_cannot_empty");
                MessageBox.Show(warning);
                return;
            }

            ProgramStorage.Instance.ProgramSuffixes = tbSuffixes.Text;
            string msg = context.API.GetTranslation("Bloop_plugin_program_update_file_suffixes");
            MessageBox.Show(msg);
        }
    }
}
