...
namespace Bloop.Plugin.Folder
{
    ...
    {
        private IPublicAPI BloopAPI;

        public FileSystemSettings(IPublicAPI BloopAPI)
        {
            this.BloopAPI = BloopAPI;
            InitializeComponent();
        ...
        private void btnDelete_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                string msg = string.Format(BloopAPI.GetTranslation("Bloop_plugin_folder_delete_folder_link"), selectedFolder.Path);
            ...
            {
                string warning = BloopAPI.GetTranslation("Bloop_plugin_folder_select_folder_link_warning");
