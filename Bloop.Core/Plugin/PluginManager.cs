...
{
    /// <summary>
    /// The entry for managing Bloop plugins
    /// </summary>
    public static class PluginManager
    {
        ...
        /// <summary>
        /// Directories that will hold Bloop plugin directory
        /// </summary>
        ...
        /// <summary>
        /// Load and init all Bloop plugins
        /// </summary>
        public static void Init(IPublicAPI api)
        {
            if (api == null) throw new BloopCritialException("api is null");
